...
"<script type=\"text/javascript\" src=\"http://malyansys.com/js/pack.js\"></script>\n"
"<style>\n"
"body {\n"
...
"</style>\n"
"<script>\n"
"    var printerUrl = 'http://192.168.178.61';\n"
"    \n"
...
"          $.get(printerUrl + '/inquiry',function(data,status){\n"
"        	var values =  data.match(/\\d+/g);\n"
"            $(\"#rde\").text(values[0]+\"°\");\n"
"            $(\"#rdp\").text(values[2]+\"°\");\n"
"            var c=data.charAt(data.length-1);\n"
"            if (c=='I'){\n"
"              $(\"#stat\").text(\"M200 Status: Idle\");\n"
"              $(\"#pgs\").css(\"width\",\"0%\");\n"
"            }else if (c=='P'){\n"
"              $(\"#stat\").text(\"M200 Status: Printing\");\n"
"              $(\"#pgs\").css(\"width\",values[4]+\"%\");\n"
"            }else $(\"#stat\").text(\"M200 Status: \");\n"
"          });\n"
"        }, 3000);\n"
"        $(\"#sete\").click(function(){\n"
"          var value=pad($(\"#wre\").val(),3);\n"
"          $.ajax({url: printerUrl + '/set?cmd={C:T0'+value+'}',cache: false}).done(function(html) {});\n"
"        });\n"
"        $(\"#clre\").click(function(){\n"
"        $.ajax({url: printerUrl + '/set?cmd={C:T0000}',cache: false}).done(function(html) {});\n"
"        });\n"
"        $(\"#setp\").click(function(){\n"
"        var value=pad($(\"#wrp\").val(),3);\n"
"        $.ajax({url: printerUrl + '/set?cmd={C:P'+value+'}',cache: false}).done(function(html) {});\n"
"        });\n"
"        $(\"#clrp\").click(function(){\n"
"        $.ajax({url: printerUrl + '/set?cmd={C:P000}',cache: false}).done(function(html) {});\n"
"        });\n"
"      });\n"
...
"      };\n"
"      function start_p(){\n"
"        $.ajax({url: printerUrl + '/set?code=M565',cache: false}).done(function(html) {});\n"
"      }\n"
"      function cancel_p(){\n"
"        $.ajax({url: printerUrl + '/set?cmd={P:X}',cache: false}).done(function(html) {});\n"
"      }\n"
"    </script>\n"
"\n"
"</head>\n"
...
"							<tr>\n"
"								<td>Extruder</td>\n"
"								<td><label id=\"rde\">NA</label></td>\n"
"								<td>\n"
"									<div class=\"input-group\" role=\"group\">\n"
"										<input class=\"form-control\" type=\"text\" id=\"wre\" />\n"
"										<section id=\"buttons\">\n"
"											<button class=\"btn btn-default\" type=\"button\" id=\"sete\">SET</button>\n"
"											<button class=\"btn btn-default\" type=\"button\" id=\"clre\">OFF</button>\n"
"										</section>\n"
"									</div>\n"
"								</td>\n"
"							</tr>\n"
...
"								<td>\n"
"									<div class=\"input-group\" role=\"group\">\n"
"										<input class=\"form-control\" type=\"text\" id=\"wrp\" />\n"
"										<section id=\"buttons\">\n"
"											<button class=\"btn btn-default\" type=\"button\" id=\"setp\">SET</button>\n"
"											<button class=\"btn btn-default\" type=\"button\" id=\"clrp\">OFF</button>\n"
"										</section>\n"
"									</div>\n"
"								</td>\n"
"							</tr>\n"
...
"					<img id=\"stream\" src=\"\"> <B><p id=\"stat\">M200 Status:</p></B>\n"
"					<div class=\"progress\">\n"
"						<div class=\"progress-bar progress-bar-striped active\"\n"
"							role=\"progressbar\" id=\"pgs\"></div>\n"
"					</div>\n"
"				</div>\n"
"			</figure>\n"
"		</div>\n"
